...
class Quiz(models.Model):
    ...
    category_id = models.ForeignKey('quiz.Category',on_delete=models.SET_NULL,null=True)
    level_id = models.ForeignKey('quiz.Level',on_delete=models.SET_NULL,null=True)
